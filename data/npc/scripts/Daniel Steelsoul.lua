...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "were") and player:getStorageValue(50745) == 1 and player:getStorageValue(50746) == 1 and player:getStorageValue(50747) == 1 and player:getStorageValue(50748) == 1 and player:getStorageValue(50749) == 1 and player:getStorageValue(Storage.CurseSpreads.roteiroquest) == 15 then
