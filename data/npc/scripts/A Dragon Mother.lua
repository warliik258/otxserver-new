...
function creatureSayCallback(cid, type, msg)
    ...
    if player:getStorageValue(10168) <= 0 then 
        if msgcontains(msg, 'assistance') then
            npcHandler:say({"Wretched creatures of ice have stolen my egg that was close to hatching. Since I'm to huge to enter those lower Tunnels I have to ask you to take care of my {egg}. Will you do this?"}, cid)
