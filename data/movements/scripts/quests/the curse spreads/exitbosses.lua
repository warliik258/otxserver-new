function onStepIn(creature, item, position, fromPosition)
	...
	elseif item.itemid == 27715 or item.itemid == 27716 then
		if creature:getStorageValue(Storage.CurseSpreads.roteiroquest) == 16 then
			...
			player:sendTextMessage(MESSAGE_STATUS_SMALL, "You're not ready to access this portal.")
		end
	end
