...
local function functionBack(position, oldpos)
	...
	for v = 1, #spectators do
		...
		if spectator:getName():lower() == 'izcandar champion of winter' or spectator:getName():lower() == 'izcandar champion of summer' then
	...
	for i = 1, #specs do
		spec = specs[i]
		if spec:isMonster() and spec:getName():lower() == 'izcandar champion of winter' or spec:getName():lower() == 'izcandar champion of summer' then
